 ...
 * @param condition
 */
export declare const givenThat: (condition: (page: Page) => Promise<boolean>) => (...actions: BotAction[]) => BotAction;
/**
...
export declare const forAll: (collection: any[] | Dictionary) => (botActionOrActionsFactory: (...args: any[]) => BotAction | BotAction[]) => (page: Page) => Promise<void>;
