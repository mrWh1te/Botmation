 ...
 * @param selector
 */
export const click = (selector: string): Action<InjectPage> => async({page}) =>
  page.click(selector)
 ...
 * @param text
 */
export const clickText = (text: string): Action<InjectPage> =>
 ...
 * @param copy
 */
export const type = (copy: string): Action<InjectPage> => async({page}) =>
