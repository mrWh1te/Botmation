/**
 * @description  Crawled URL's belonging to Twitter
 */
...
export const TWITTER_URL_BOOKMARKS = TWITTER_URL_BASE + 'i/bookmarks'

export const TWITTER_URL_SETTINGS = TWITTER_URL_BASE + 'settings'

export const TWITTER_URL_LOGIN = TWITTER_URL_BASE + 'login'
export const TWITTER_URL_LOGOUT = TWITTER_URL_BASE + 'logout'
